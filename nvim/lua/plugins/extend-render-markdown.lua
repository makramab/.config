  ...
  opts = {
    ...
    win_options = {
      ...
      conceallevel = {
        ...
        -- value = 0; No concealment; text is shown normally.
        -- value = 1; Concealed text is hidden but can be revealed when the cursor is over it.
        -- value = 2; Concealed text is replaced by a "conceal character" (like → for -->).
        -- value = 3; Concealed text is completely hidden, even under the cursor.
        rendered = 2,
      },
      -- See :h 'concealcursor'
      concealcursor = {
